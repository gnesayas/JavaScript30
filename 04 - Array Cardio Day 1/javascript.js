...
console.table(inventorsFirstLast);

// Array.prototype.sort()
// 3. Sort the inventors by birthdate, oldest to youngest
const inventorsSorted = inventors.sort(
    (inventor1, inventor2) => inventor2.year - inventor1.year);
...
const inventorsSortedByLifetime = inventors.sort(
...
// const de = linkArray.map(
//     (link) => link.innerText).filter(
//         (text) => text.indexOf('de') >= 0);
